...
export const EVENT_KEYS: Record<typeof EventKeys[number], string> = Object.freeze(generateKeyHash(EventKeys))

export const LOWERCASE_TAGS: Record<typeof blockContainerElementNames[number], string> = Object.freeze(
...
export const CLASS_OR_ID: Record<typeof typeList[number], string> = Object.freeze(genUpper2LowerKeyHash(typeList))
...
export const DEFAULT_TURNDOWN_CONFIG = Object.freeze({
  ...
  blankReplacement(content: string, node: HTMLElement, options: any) {
