...
export const quickInsertObj: Record<string, Array<IQuickInsert>> = {
  'basic block': [
    {
      title: 'Paragraph',
...
type IQuickInsertObj = typeof quickInsertObj

export type IQuickObjKeys = keyof IQuickInsertObj
