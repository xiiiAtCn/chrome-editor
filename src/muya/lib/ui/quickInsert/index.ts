...
import { IQuickInsert, quickInsertObj } from './config'
import './index.css'

class QuickInsert extends BaseScrollFloat<any> {
  ...
  search(text: string) {
    ...
    const obj = deepCopy<Record<string, IQuickInsert[]>>(quickInsertObj)
